...
### Phase 0: Pre-requisite Cleanup (Terminology & YAML)
...
### Phase 2: Scenario YAML Schema Updates
...
### Phase 8: Build, Test, and Bug-Fix
...
0. **Phase 0**: Pre-requisite cleanup - Add `--litserve`, remove `distributed` from YAML
1. **Phase 1**: Protocol buffers - Define all new messages and RPCs
2. **Phase 2**: YAML schema - Update example scenarios
3. **Phase 3**: C++ server - Add edge registration and routing
4. **Phase 4**: Edge process - Create standalone edge
5. **Phase 5**: Actor client - Add connection discovery
6. **Phase 6**: sim_api.py - Compute and send edge mappings
7. **Phase 7**: Shell scripts - Update container orchestration
8. **Phase 8**: Build, test, and bug-fix the new edge architecture
