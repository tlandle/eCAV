...
Typically each process will spawn its own perception stack. The perception stack is a mix of LiDAR and cameras - defined in the YAML for a given scenario. Perception stack modules are located in `ecav/core/sensing`.
