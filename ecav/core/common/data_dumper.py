...
from ecav.core.sensing.perception import sensor_transformation as st
from ecav.scenario_testing.utils.yaml_utils import save_yaml
...
class DataDumper(object):
    ...
    ----------
    rgb_camera : list
        A list of ecav.CameraSensor that containing all rgb sensor data
    ...
    def run_step(self,
        ...
        ----------
        perception_manager : ecav object
            eCAV perception manager.

        localization_manager : ecav object
            eCAV localization manager.

        behavior_agent : ecav object
            Open
        """
        self.count += 1
