...
from ecav.core.common.misc import compute_distance, cal_distance_angle
from ecav.core.application.platooning.fsm import FSM
...
class PlatooningPlugin(object):
    ...
    front_vehicle : ecav object
        The front vehicle manager of the ego vehicle.

    rear_vechile : ecav object
