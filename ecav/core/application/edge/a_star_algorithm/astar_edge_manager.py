...
sys.path.append("/home/chattsgpu/Documents/Carla_ecav/TrafficSimulator_eCloud/eCAV/")

import ecav.core.plan.drive_profile_plotting as open_plt
from ecav.core.application.edge.EdgeManager import *
...
from ecav.core.application.edge.edge_metrics import \
    EdgeMetrics

# Algorithm specific import
from ecav.core.application.edge.a_star_algorithm.astar_test_groupcaps_transform import *
from ecav.core.application.edge.a_star_algorithm.transform_utils import *
from ecav.core.application.edge.a_star_algorithm.a_star_carla_helper import *
import grpc
