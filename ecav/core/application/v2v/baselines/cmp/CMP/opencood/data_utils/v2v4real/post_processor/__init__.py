from opencood.data_utils.v2v4real.post_processor.voxel_postprocessor import VoxelPostprocessor
from opencood.data_utils.v2v4real.post_processor.bev_postprocessor import BevPostprocessor
