...
def eval_single_ckpt(model, test_loader, args, eval_output_dir, logger, epoch_id, dist_test=False):
    ...
    # start evaluation
    eval_utils.eval_one_epoch_custom(model, test_loader, epoch, logger, save_to_file=args.save_to_file, result_dir=eval_output_dir)
...
def repeat_eval_ckpt(model, test_loader, args, eval_output_dir, logger, ckpt_dir, dist_test=False):
    ...
    while True:
        ...
        tb_dict = eval_utils.eval_one_epoch_custom(model, test_loader, cur_epoch_id, logger)
