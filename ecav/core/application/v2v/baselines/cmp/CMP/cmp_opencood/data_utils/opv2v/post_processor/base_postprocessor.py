...
class BasePostprocessor(object):
    ...
    def generate_gt_bbx(self, data_dict, for_tracking=False):
        """
        ...
        gt_object_id_tensor = torch.tensor(list(set(object_id_list))).to(gt_box3d_tensor.device)
        ...
        gt_object_id_tensor = gt_object_id_tensor[mask]
