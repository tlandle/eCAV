...
from cmp_opencood.data_utils.v2v4real.post_processor.base_postprocessor \
    import BasePostprocessor
from cmp_opencood.utils import box_utils_v2v4real as box_utils
from cmp_opencood.utils.box_overlaps import bbox_overlaps
...
class VoxelPostprocessor(BasePostprocessor):
    ...
    def post_process(self, data_dict, output_dict, for_tracking=False):
        ...
        if len(pred_box2d_list) ==0 or len(pred_box3d_list) == 0:
            # return None, None
            return (None, None, None) if for_tracking else (None, None)
        # shape: (N, 5)
        ...
        if for_tracking:
            return pred_box3d_tensor, boxes3d, scores
        else:
            return pred_box3d_tensor, scores
