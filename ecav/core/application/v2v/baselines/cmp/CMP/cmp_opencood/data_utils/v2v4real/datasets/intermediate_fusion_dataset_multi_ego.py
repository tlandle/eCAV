...
import cmp_opencood.utils.pcd_utils as pcd_utils
from cmp_opencood.data_utils.v2v4real.augmentor.data_augmentor import DataAugmentor
from cmp_opencood.hypes_yaml.yaml_utils import load_yaml
import cmp_opencood.data_utils.v2v4real.datasets
import cmp_opencood.data_utils.v2v4real.post_processor as post_processor
from cmp_opencood.utils import box_utils_v2v4real
from cmp_opencood.data_utils.v2v4real.pre_processor import build_preprocessor
from cmp_opencood.utils.pcd_utils import \
    mask_points_by_range, mask_ego_points, shuffle_points, \
    downsample_lidar_minimum
from cmp_opencood.utils.transformation_utils import x1_to_x2, dist_two_pose
...
class IntermediateFusionDatasetMultiEgo(Dataset):
    ...
    def retrieve_base_data(self, idx, cur_ego_pose_flag=True):
        ...
        for cav_id, cav_content in scenario_data_on_ego_cav.items():
            ...
            data[cav_id]['params'] = self.reform_param(cav_content,
                                                    ...
                                                    cur_ego_pose_flag)
            if int(ego_cav_id) == 0:
                data[cav_id]['ego_transformation_matrix'] = data[cav_id]['params']['transformation_matrix']
            elif int(ego_cav_id) == 1:
                data[cav_id]['ego_transformation_matrix'] = self.get_transformation_matrix(ego_cav_content,
                                                    scenario_data_on_ego_cav['0'],
                                                    timestamp_key,
                                                    timestamp_key_delayed,
                                                    cur_ego_pose_flag)
    ...
    def get_transformation_matrix(self, cav_content, ego_content, timestamp_cur,
                     timestamp_delay, cur_ego_pose_flag):
        cur_params = load_yaml(cav_content[timestamp_cur]['yaml'])
        cur_ego_params = load_yaml(ego_content[timestamp_cur]['yaml'])
    ...
    def __getitem__(self, idx):
        ...
        for cav_id, selected_cav_base in base_data_dict.items():
            ...
            if distance > opencood.data_utils.v2v4real.datasets.COM_RANGE:
                continue

            transformation_matrix.append(selected_cav_base['ego_transformation_matrix'])
            # if int(cav_id) != ego_cav_id:
            #     cav_lidar_pose = selected_cav_base['params']['lidar_pose']
            #     # print("Not equal")
            # else:
            #     cav_lidar_pose = ego_lidar_pose
            #     # print("Equal")
            ...
            if self.visualize:
                ...
                projected_lidar = \
                    np.r_[projected_lidar.T,
                          [np.ones(projected_lidar.shape[0])*idx]].T
        ...
        processed_data_dict['ego'].update(
            ...
            #  'object_bbx_world_coord': object_world_coord_stack,
             ...
             "ego_cav_id": ego_cav_id,
             "ego_transformation_matrix": transformation_matrix})
    ...
    def get_item_single_car(self, selected_cav_base, ego_pose):
        ...
        # if self.proj_first:
        lidar_np[:, :3] = \
            box_utils_v2v4real.project_points_by_matrix_torch(lidar_np[:, :3],
                                                        transformation_matrix)
        ...
        object_bbx_center_valid, range_mask = \
            box_utils_v2v4real.mask_boxes_outside_range_numpy(object_bbx_center_valid,
                                                     self.params['preprocess'][
                                                         'cav_lidar_range'],
    ...
    def collate_batch_train(self, batch):
        ...
        for i in range(len(batch)):
            ...
            transformation_matrix_list.append(ego_dict['ego_transformation_matrix'])
        ...
        transformation_matrix = torch.from_numpy(np.array(transformation_matrix_list))
        ...
        output_dict['ego'].update({'object_bbx_center': object_bbx_center,
                                ...
                                #    'object_bbx_world_coord': object_bbx_world_coord,  # Comment for training, Uncomment for testing
                                   ...
                                   'transformation_matrix_list': transformation_matrix # Comment for training, Uncomment for testing
                                })
