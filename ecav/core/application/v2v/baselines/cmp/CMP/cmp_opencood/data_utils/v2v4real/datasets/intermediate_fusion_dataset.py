...
from cmp_opencood.data_utils.v2v4real.datasets import basedataset
...
class IntermediateFusionDataset(basedataset.BaseDataset):
    ...
    def __getitem__(self, idx):
        ...
        for cav_id, cav_content in base_data_dict.items():
            if cav_content['ego']:
                ...
                ego_timestamp = cav_content['index']
    ...
    def collate_batch_train(self, batch):
        ...
        for i in range(len(batch)):
            ...
            timestamp_list.append(ego_dict['ego_timestamp'])
            timestamp_key_list.append(ego_dict['ego_timestamp_key'])
            ego_cav_id.append(ego_dict['cav_id'])
