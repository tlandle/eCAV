...
from cmp_opencood.data_utils.v2v4real.post_processor import build_postprocessor
...
class LateFusionDataset(basedataset.BaseDataset):
    ...
    def collate_batch_test(self, batch):
        ...
        timestamp_list.append(cav_content['ego_timestamp'])
        timestamp_key_list.append(cav_content['ego_timestamp_key'])
        ego_cav_id.append(cav_content['cav_id'])
