...
import cmp_opencood.data_utils.opv2v.datasets
import cmp_opencood.data_utils.opv2v.post_processor as post_processor
from cmp_opencood.utils import box_utils
from cmp_opencood.data_utils.opv2v.datasets import basedataset
from cmp_opencood.data_utils.opv2v.pre_processor import build_preprocessor
...
class IntermediateFusionDataset(basedataset.BaseDataset):
    ...
    def __getitem__(self, idx):
        ...
        # if len(unique_indices) != len(object_world_coord_stack.keys()):
    ...
    def collate_batch_train(self, batch):
        ...
        object_bbx_world_coord = torch.from_numpy(np.array(unprocessed_lidar_list))  # Comment for training, Uncomment for testing
