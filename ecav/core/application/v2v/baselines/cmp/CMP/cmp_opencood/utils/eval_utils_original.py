...
from cmp_opencood.hypes_yaml import yaml_utils
...
def eval_final_results(result_stat, save_path, range=""):
    ...
    ap_30, ar_30, mrec_30, mpre_30 = calculate_ap(result_stat, 0.30)
    ap_50, ar_50, mrec_50, mpre_50 = calculate_ap(result_stat, 0.50)
    ap_70, ar_70, mrec_70, mpre_70 = calculate_ap(result_stat, 0.70)
