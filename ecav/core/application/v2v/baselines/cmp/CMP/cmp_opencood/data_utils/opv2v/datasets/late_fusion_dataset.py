...
from cmp_opencood.data_utils.opv2v.post_processor import build_postprocessor
    ...
    def get_item_test(self, base_data_dict):
        ...
        for cav_id, cav_content in base_data_dict.items():
            if cav_content['ego']:
                ...
                ego_timestamp_idx = cav_content['timestamp']
                break
