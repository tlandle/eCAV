#!/usr/bin/env python
"""
Scenario 3 with 2 ego vehicles — visualization metadata.
Used by show_spawn_points.py for path visualization.
"""

import carla

class Scenario_3_2Ego_Viz:
    """Metadata for show_spawn_points.py."""

    def __init__(self):
        self.vehicle_01_velocity = 70  # cav2: West approach (eastbound)
        self.vehicle_02_velocity = 25  # Lincoln NPC
        self.vehicle_03_velocity = 0  # Occlusion vehicle
        self.vehicle_04_velocity = 0  # Occlusion vehicle
