#!/usr/bin/env python
"""
Scenario 3 with 8 ego vehicles — visualization metadata.
Used by show_spawn_points.py for path visualization.
"""

import carla

class Scenario_3_8Ego_Viz:
    ...
    def __init__(self):
        ...
        self.vehicle_08_velocity = 25  # Lincoln NPC
        self.vehicle_09_velocity = 0  # Occlusion vehicle
        self.vehicle_10_velocity = 0  # Occlusion vehicle
        self.vehicle_11_velocity = 0  # Occlusion vehicle
        self.vehicle_12_velocity = 0  # Occlusion vehicle
        self.vehicle_13_velocity = 0  # Occlusion vehicle
