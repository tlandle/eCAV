...
"""
Scenario 3 with Edge Support and Route XML Navigation

This scenario demonstrates the use of route XML files for multi-waypoint
navigation with edge-based cooperative perception. The ego vehicle follows
a predefined route through an intersection with left turn maneuver.
"""
...
MAX_STEP = 600
SCENARIO_NAME = 'openscenario_3_edge_route'
...
def run_scenario(opt, scenario_params):
    """
    Run the edge scenario with route-based navigation.
