...
Use for eCAV vs eCloudSim DIST-ONLY comparisons
...
import ecav.scenario_testing.utils.customized_map_api as map_api
...
def run_scenario(opt, scenario_params):
    ...
    try:
        ...
        while flag:
            ...
            transform = edge_list[0].vehicle_manager_list[0].vehicle.get_transform()
