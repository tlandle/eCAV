...
"""
VIPS (Vehicular Intersection Perception System) baseline scenario.

This scenario runs the VIPS infrastructure-only perception baseline for
benchmarking against cooperative perception approaches:
- Late fusion with self-beacon anchoring
- BM2CP (intermediate fusion)
- WorldFusion (intermediate fusion with Where2comm)

VIPS uses ONLY RSU sensors - no vehicle sensor contributions and no
self-beacon anchoring. This answers the reviewer question:
"Can VIPS achieve what self-beacon anchoring provides?"
"""
import time
...
MAX_STEP = 600
SCENARIO_NAME = 'openscenario_3_edge_vips'
...
def run_scenario(opt, scenario_params):
    ...
    try:
        ...
        print("="*60)
        print("VIPS Baseline - Infrastructure-Only Perception")
        print("RSU sensors only, no vehicle contributions")
        print("="*60)
