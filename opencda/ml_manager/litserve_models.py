...
def load_wf_model():
    ...
    if _wf_model is None:
        ...
        hypes_path = os.environ.get(
            'WF_HYPES_YAML',
            'opencda/BM2CP/opencood/logs/worldfusion_v2xsim_det_2026_01_19_21_00_10/config.yaml'
        )
        ckpt_path = os.environ.get(
            'WF_CHECKPOINT',
            'opencda/BM2CP/opencood/logs/worldfusion_v2xsim_det_2026_01_19_21_00_10/net_epoch50.pth'
        )
